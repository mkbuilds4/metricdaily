  ...
  },
  {
    ...
    content: (
      <>
        ...
        <h3 className="font-semibold text-lg mt-4">Understanding Units and UPH</h3>
        <p>
    ...
    content: (
      <>
        ...
        <ol className="list-decimal pl-5 space-y-1">
         ...
         <h3 className="font-semibold text-lg mt-4">Tips for Success</h3>
        <ul className="list-disc pl-5 space-y-1">
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleOpenChange}>
      ...
      <DialogContent className="sm:max-w-[600px] md:max-w-[700px] lg:max-w-[800px] flex flex-col">
        ...
        <div className="prose prose-sm dark:prose-invert max-h-[60vh] overflow-y-auto pr-3 space-y-4 text-foreground flex-grow">
          <section>
